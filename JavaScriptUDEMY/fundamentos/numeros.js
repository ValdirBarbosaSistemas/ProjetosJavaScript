...
console.log(peso1)
console.log(peso2)
console.log(Number.isInteger(peso1)) //Dizer que tipo de Number é (inteiro ou não)
...
console.log(media.toString) // 'to string' serve para converter o number em String